# -*- coding: utf-8 -*-
#
# zodb_auth documentation build configuration file
#
...
html_theme = 'pyramid'
html_theme_options = dict(github_url='http://github.com/Pylons/zodb_auth')
...
latex_documents = [
  ('index', 'zodb_auth.tex', 'zodb_auth Documentation',
